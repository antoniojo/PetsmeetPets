			...
			<div class="container text-center">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<div class="intro">							
							<div class="scrolltop">                     <ul>
									<li>
										<h3>Bienvenido</h3>
										<p>Estás registrado correctamente</p>
									</li>
									<li>
										<h3>Bienvenido</h3>
										<p>En breve podrás disfrutar de todos nuestros servicios</p>
									</li>	
									<li>
										<h3>Bienvenido</h3>
							...
							<p>
							 Pets meet Pets aún está en fase beta. 
							</p>
                            <p>
							 Estamos ultimando nuestros servicios y productos para poder ofrecértelos en breve.
							</p>
                            <p> </p>
							<a href="index.php" class="btn btn-lg btn-tertiary">Volver</a>
                            <p> </p>
